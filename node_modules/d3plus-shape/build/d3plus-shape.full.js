...
(function (global, factory) {
  ...
  function selectAll(selector) {
    return typeof selector === "string" ? new Selection$1([document.querySelectorAll(selector)], [document.documentElement]) : new Selection$1([selector == null ? [] : array$1(selector)], root);
  }
  ...
  */
  ...
  function isObject(item) {
    return item && _typeof$2(item) === "object" && (typeof window === "undefined" || item !== window && item !== window.document && !(item instanceof Element)) && !Array.isArray(item) ? true : false;
  }
  /**
    ...
    availableKeys.forEach(function (k) {
      ...
      if (aggs[k]) value = aggs[k](objects, function (o) {
        ...
        if (!types.length) value = undefined;else if (types.indexOf(Array) >= 0) {
          ...
          value = unique(values);
          if (value.length === 1) value = value[0];
        } else if (types.indexOf(Number) >= 0) value = sum$1(values);else if (types.indexOf(Object) >= 0) {
          ...
          if (w > fMin && (h > lH || resize && h > fMin * lHRatio)) {
            if (resize) {
              ...
              var areaMod = 1.165 + w / h * 0.1,
                  ...
                  textArea = sum$1(sizes, function (d) {
                return d * lH;
              }) * areaMod;
  ...
  var Shape = /*#__PURE__*/function (_BaseClass2) {
    ...
    */
    function Shape() {
      ...
      _this4._ariaLabel = constant$1("");
      _this4._backgroundImage = constant$1(false);
      _this4._backgroundImageClass = new Image();
      _this4._data = [];
      _this4._duration = 600;
      _this4._fill = constant$1("black");
      _this4._fillOpacity = constant$1(1);
      ...
      _this4._label = constant$1(false);
      ...
      _this4._name = "Shape";
      _this4._opacity = constant$1(1);
      _this4._pointerEvents = constant$1("visiblePainted");
      _this4._role = constant$1("presentation");
      _this4._rotate = constant$1(0);
      _this4._rx = constant$1(0);
      _this4._ry = constant$1(0);
      _this4._scale = constant$1(1);
      _this4._shapeRendering = constant$1("geometricPrecision");

      _this4._stroke = function (d, i) {
        return color(_this4._fill(d, i)).darker(1);
      };

      _this4._strokeDasharray = constant$1("0");
      _this4._strokeLinecap = constant$1("butt");
      _this4._strokeOpacity = constant$1(1);
      _this4._strokeWidth = constant$1(0);
      _this4._tagName = tagName;
      _this4._textAnchor = constant$1("start");
      _this4._vectorEffect = constant$1("non-scaling-stroke");
      _this4._verticalAlign = constant$1("top");
  ...
  var Area = /*#__PURE__*/function (_Shape) {
    ...
    */
    function Area() {
      ...
      _this10._curve = constant$1("linear");
      ...
      _this10._x1 = null;
      _this10._y = constant$1(0);
      _this10._y0 = constant$1(0);
    ...
    _createClass2(Area, [{
      ...
      */
      ...
      value: function curve(_) {
        return arguments.length ? (this._curve = typeof _ === "function" ? _ : constant$1(_), this) : this._curve;
      }
      /**
          @memberof Area
  ...
  var Bar = /*#__PURE__*/function (_Shape2) {
    ...
    */
    function Bar() {
      ...
      _this14._width = constant$1(10);
      _this14._x = accessor("x");
      _this14._x0 = accessor("x");
      _this14._x1 = null;
      _this14._y = constant$1(0);
      _this14._y0 = constant$1(0);
  ...
  var Line = /*#__PURE__*/function (_Shape5) {
    ...
    */
    function Line() {
      ...
      _this21._curve = constant$1("linear");

      _this21._defined = function (d) {
        return d;
      };

      _this21._fill = constant$1("none");
      _this21._hitArea = constant$1({
        "d": function d(_d2) {
      ...
      _this21._name = "Line";
      _this21._path = line();
      _this21._stroke = constant$1("black");
      _this21._strokeWidth = constant$1(1);
      return _this21;
    }
    /**
        @memberof Line
    ...
    _createClass2(Whisker, [{
      ...
      value: function render(callback) {
        ...
        nest().key(function (d) {
          ...
          _this26._whiskerEndpoint.push(new shapes$1[shapeName]().data(shapeData.values).select(elem("g.d3plus-Whisker-Endpoint-".concat(shapeName), {
  ...
  var Box = /*#__PURE__*/function (_BaseClass4) {
    ...
    */
    function Box() {
      ...
      _this27._rectWidth = constant$1(50);
    ...
    _createClass2(Box, [{
      ...
      value: function render() {
        ...
        var filteredData = nest().key(function (d, i) {
          ...
          } else if (mode[0] === "extent") d.lowerLimit = min$1(values);else if (typeof mode[0] === "number") d.lowerLimit = quantile(values, mode[0]);

          if (mode[1] === "tukey") {
            d.upperLimit = d.third + (d.third - d.first) * 1.5;
            if (d.upperLimit > max$1(values)) d.upperLimit = max$1(values);
          } else if (mode[1] === "extent") d.upperLimit = max$1(values);else if (typeof mode[1] === "number") d.upperLimit = quantile(values, mode[1]);
        ...
        nest().key(function (d) {
          ...
          _this28._whiskerEndpoint.push(new shapes[shapeName]().data(shapeData.values).select(elem("g.d3plus-Box-Outlier-".concat(shapeName), {
  ...
  var shapeEdgePoint = function shapeEdgePoint(angle, distance) {
    ...
    if (shape === "square") {
      ...
      if (angle < pi$1 / 2) {
        ...
        var _tan = Math.tan(pi$1 - angle);

        _x3 -= angle < pi$1 - diagonal ? distance / _tan : distance;
        _y3 += angle < pi$1 - diagonal ? distance : _tan * distance;
      } else if (angle < diagonal + pi$1) {
        _x3 -= distance;
        _y3 -= Math.tan(angle - pi$1) * distance;
      } else if (angle < 3 * pi$1 / 2) {
        _x3 -= distance / Math.tan(angle - pi$1);
        _y3 -= distance;
      } else if (angle < 2 * pi$1 - diagonal) {
        _x3 += distance / Math.tan(2 * pi$1 - angle);
        _y3 -= distance;
      } else {
        _x3 += distance;
        _y3 -= Math.tan(2 * pi$1 - angle) * distance;
      }
  ...
  var path2polygon = function path2polygon(path) {
    ...
    while (match !== null) {
      if (["M", "L"].includes(match[1])) poly.push(match[2].split(",").map(Number));else if (match[1] === "A") {
        ...
        var _step17 = angle / (angle / (pi * 2) * (radius * pi * 2) / segmentLength);

        var _start = Math.atan2(-prev[1], -prev[0]) - pi;
  ...
  */
  ...
  var Path = /*#__PURE__*/function (_Shape6) {
    ...
    _inherits2(Path, _Shape6);

    var _super10 = _createSuper2(Path);
    ...
    */
    ...
    _createClass2(Path, [{
      ...
      */
      ...
      key: "render",
      value: function render(callback) {
        _get(_getPrototypeOf2(Path.prototype), "render", this).call(this, callback);
