...
(function (global, factory) {
  ...
  */
  ...
  var formatDefaultLocale = function formatDefaultLocale(definition) {
    var locale = defaultLocale$2(definition);
  ...
  */
  ...
  function formatDate(d, dataArray) {
    ...
    var steps = dataArray.reduce(function (arr, d, i) {
      if (i) arr.push(monthDiff(dataArray[i - 1], d));
      return arr;
    }, []);
    var quarterSteps = steps.find(function (s) {
      return s === 3;
    }) && steps.every(function (d) {
      return d >= 3 && !(d % 3);
    });
